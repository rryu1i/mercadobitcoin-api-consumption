...
class TestIngestors:
    ...
    def test_load_checkpoint_existing_checkpoint(
        self, mock, data_ingestor_fixture
    ):
        actual = data_ingestor_fixture._load_checkpoint()
    ...
    def test_update_checkpoint_checkpoint_updated(
        self, mock, data_ingestor_fixture
    ):
    ...
    def test_update_checkpoint_checkpoint_written(
        self, mock, data_ingestor_fixture
    ):
        data_ingestor_fixture._update_checkpoint(
            value=datetime.date(2019, 1, 1)
